...
class AIScriptEngine:
    """Production script editor; provider failures are explicit."""
...
def _normalize_to_story(candidate: StoryPlan, original: StoryPlan) -> StoryPlan:
    ...
    for index, base in enumerate(original.scenes):
        ...
        scenes.append(ScenePlan(base.number, edited.title or base.title, base.duration_seconds, edited.visual or base.visual, edited.narration or base.narration, shots))
