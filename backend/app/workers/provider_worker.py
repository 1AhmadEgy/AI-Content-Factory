...
class ProviderGenerationWorker(Worker):
    """Execute real providers and materialize cache hits as fresh project assets."""
    ...
    def execute(self, job: GenerationJob, context: WorkerContext) -> JobExecutionResult:
        ...
        if cached is not None:
            ...
            return JobExecutionResult(success=True, asset_ids=asset_ids, metrics={**cached.metrics, "cache_hit": 1.0}, provider_run_id=response.provider_run_id)
