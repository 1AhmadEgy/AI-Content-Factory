...
class TimelineWorker(Worker):
    ...
    def execute(self, job: GenerationJob, context: WorkerContext) -> JobExecutionResult:
        ...
        asset = Asset(
            ...
            provenance=build_provenance(job, source_asset_ids=asset_ids, metadata={"provider": "aicf-timeline", "timelineId": timeline.id, "languageRender": language_render}, license_status=LicenseStatus.VERIFIED),
        )
