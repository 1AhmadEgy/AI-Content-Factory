...
class WorkerRegistry:
    ...
    def resolve_for_job(self, job_type: JobType | str) -> str:
        ...
        specialized = {"QC": "quality-control", "BEST_TAKE": "best-take", "TIMELINE": "timeline", "RENDER": "render", "SUBTITLE": "media-document", "THUMBNAIL": "media-document", "METADATA": "media-document", "PUBLISH": "publish", "REPURPOSE": "repurpose", "BATCH": "batch"}
