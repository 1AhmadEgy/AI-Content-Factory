...
_COUNTRIES: tuple[dict[str, object], ...] = (
    ...
    {"id": "libya", "name": "Libya", "nativeName": "ليبيا", "countryCode": "LY", "locale": "ar-LY", "defaultLanguage": "ar", "dialects": ["ar-LY"], "supportedLanguages": list(COMMON_LANGUAGES), "libraryId": "local-library-libya", "status": "catalog-only", "libraryVersion": 1},
