...
val releaseVersion = providers.environmentVariable("RELEASE_VERSION").orElse("1.0.0").get()
val releaseVersionCode = providers.environmentVariable("RELEASE_VERSION_CODE").orElse("1").get().toInt()
