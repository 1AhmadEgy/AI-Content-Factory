...
data class SeriesTemplate(
    ...
    val episode: Map<String, Any?> = emptyMap(),
    val continuity: Map<String, Any?> = emptyMap(),
    val storyRules: List<String> = emptyList(),
    val visual: Map<String, Any?> = emptyMap(),
    val audio: Map<String, Any?> = emptyMap(),
    val defaults: SeriesDefaults = SeriesDefaults(),
)

@JsonClass(generateAdapter = true)
data class SeriesDefaults(
    val characterIds: List<String> = emptyList(),
    val locationIds: List<String> = emptyList(),
)

@JsonClass(generateAdapter = true)
data class ApplySeriesTemplateRequest(
...
data class SeriesContext(
    ...
    val relationships: List<Map<String, Any?>> = emptyList(),
    val facts: List<Map<String, Any?>> = emptyList(),
    val runningGags: List<Map<String, Any?>> = emptyList(),
    val openThreads: List<Map<String, Any?>> = emptyList(),
    val importantProps: List<Map<String, Any?>> = emptyList(),
    val timeline: List<Map<String, Any?>> = emptyList(),
    val episodeSnapshots: List<Map<String, Any?>> = emptyList(),
